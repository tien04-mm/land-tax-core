...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th5 23, 2026 lúc 06:38 AM
...
--
-- Cơ sở dữ liệu: `land_tax_management`
--
...
(1, '079090012345', 'Le Hai Dang (Admin)', '0911223344', 'dang.lh@mock.vn'),
...
(4, '001099012345', 'Nguyen Van Binh (Citizen)', '0912999888', 'binh.nv@mock.vn'),
(5, '001201000011', 'Lý Nhã Kỳ', '0983314836', 'tien06062004t@gmail.com'),
...
(11, '000000000000', 'Admin Mới', '0900000000', 'admin.moi@mock.vn'),
(12, '012345678901', 'Nguyễn Văn Thuế', '0988777666', 'thue.nv@mock.vn'),
(13, '012345678902', 'Trần Thị Địa', '0988777555', 'dia.tt@mock.vn');
...
(1, 1, 1, '101', '01', 85.50, '50 năm', 'Đất ở đô thị', 'Nhà nước giao đất có thu tiền', 'Số 10 Phố Huế', 'CH12345678', 'CS1001', NULL, 'Nhà cấp 4, 30m2', 'Tường rào kiên cố'),
(2, 1, 3, '205', '05', 120.00, NULL, NULL, NULL, 'Số 20 Kim Mã', NULL, NULL, NULL, NULL, NULL),
(3, 1, 5, '308', '12', 200.00, NULL, NULL, NULL, 'Số 5 Dịch Vọng', NULL, NULL, NULL, NULL, NULL),
(4, 2, 9, '412', '20', 350.00, NULL, NULL, NULL, 'Tây Mỗ', NULL, NULL, NULL, NULL, NULL),
(5, 3, 9, '550', '21', 1500.00, NULL, NULL, NULL, 'Cánh đồng Tây Mỗ', NULL, NULL, NULL, NULL, NULL),
(6, 1, 2, '102', '01', 60.00, NULL, NULL, NULL, 'Số 15 Hàng Bài', NULL, NULL, NULL, NULL, NULL),
(7, 1, 4, '206', '05', 90.00, NULL, NULL, NULL, 'Số 30 Đội Cấn', NULL, NULL, NULL, NULL, NULL),
(8, 1, 6, '309', '12', 150.00, 'Lâu dài', 'Đất trồng cây lâu năm', 'Được thừa kế', 'Số 8 Mai Dịch', 'CH88888888', 'CS2002', NULL, 'Nhà 2 tầng, 80m2', 'Bể bơi mini'),
(9, 9, 1, '888', '02', 500.00, NULL, NULL, NULL, 'Tòa nhà Phố Huế', NULL, NULL, NULL, NULL, NULL),
(10, 4, 10, '999', '25', 1000.00, NULL, NULL, NULL, 'Mễ Trì', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `processing_logs` (
  ...
  `action_type` varchar(50) DEFAULT 'SYSTEM_ACTION',
...
INSERT INTO `processing_logs` (`plog_id`, `record_id`, `processor_account_id`, `processing_step`, `old_status`, `new_status`, `processor_notes`, `processed_at`, `action_type`, `actor_id`, `target_type`, `target_id`, `old_data`, `new_data`) VALUES
(1, 1, 3, 'Xác nhận', NULL, 'VERIFIED', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL),
(2, 1, 2, 'Áp thuế', NULL, 'APPROVED', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL),
(3, 2, 3, 'Xác nhận', NULL, 'VERIFIED', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL),
(4, 2, 2, 'Áp thuế', NULL, 'APPROVED', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL),
(5, 3, 3, 'Xác nhận', NULL, 'VERIFIED', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL),
(6, 3, 2, 'Áp thuế', NULL, 'APPROVED', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL),
(7, 4, 2, 'Áp thuế', NULL, 'APPROVED', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL),
(8, 5, 2, 'Áp thuế', NULL, 'APPROVED', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL),
(9, 6, 3, 'Tiếp nhận', NULL, 'PENDING', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL),
(10, 7, 2, 'Áp thuế', NULL, 'APPROVED', NULL, '2026-05-20 16:47:09', 'SYSTEM_ACTION', NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `reconciliation_batches`
--
...
--
-- Đang đổ dữ liệu cho bảng `reconciliation_batches`
--
...
--
-- Cấu trúc bảng cho bảng `tax_payment_details`
--
...
--
-- Đang đổ dữ liệu cho bảng `tax_payment_details`
--
...
--
-- Đang đổ dữ liệu cho bảng `tax_rates`
--
...
--
-- Chỉ mục cho bảng `reconciliation_batches`
--
...
--
-- Chỉ mục cho bảng `tax_payment_details`
--
...
--
-- AUTO_INCREMENT cho bảng `reconciliation_batches`
--
ALTER TABLE `reconciliation_batches`
...
--
-- AUTO_INCREMENT cho bảng `tax_payment_details`
--
ALTER TABLE `tax_payment_details`
...
--
-- Các ràng buộc cho bảng `reconciliation_batches`
--
ALTER TABLE `reconciliation_batches`
...
--
-- Các ràng buộc cho bảng `tax_payment_details`
--
ALTER TABLE `tax_payment_details`
